  ...
  <div class="container mx-auto my-24">
    ...
    <div class="bg-ebony-clay-900 p-8 rounded-xl mx-auto shadow-xl w-1/3 font-main">
      <form action="/registeruser" method="post">
        @csrf
        <div class="mb-6">
          <label for="base-input" class="block mb-2 text-gray-300 font-bold text-base">EMAIL</label>
          <input type="email" id="base-input" name="email" class="bg-gradient-to-br from-ebony-clay-500 to-white text-gray-900 text-lg font-semibold rounded-xl focus:outline-none focus:bg-gray-300 block w-full px-2.5 py-4">
        </div>
        <div class="mb-6">
