      ...
      <div class="overflow-y-auto w-64 bg-ebony-clay-900 h-screen fixed py-4 px-3 justify-between flex flex-col">
         <div class="">
            ...
            <ul class="space-y-2 font-ubuntu mt-20">
               <li>
                  <a href="/data-pegawai" class="flex pl-8 items-center p-2 text-base font-normal text-gray-400 rounded-lg hover:bg-[#5A6C7C] hover:text-gray-100">
                  <i class="fa-solid fa-users text-[#B2FEFE] text-xl"></i>
                     <span class="ml-4 font-bold text-lg font-main">Data Pegawai</span>
                  </a>
               </li>
               <li>
               <a href="/data-golongan" class="flex pl-8 items-center p-2 text-base font-normal text-gray-400 rounded-lg hover:bg-[#5A6C7C] hover:text-gray-100">
                  <i class="fa-solid fa-address-book text-[#B2FEFE] text-xl"></i>
                  <span class="ml-5 font-bold text-lg font-main">Data Golongan</span>
               </a>
            </li>
            <li>
               <a href="/detail-kepegawaian" class="flex pl-8 items-center p-2 text-base font-normal text-gray-400 rounded-lg hover:bg-[#5A6C7C] hover:text-gray-100">
               <i class="fa-solid fa-briefcase text-[#B2FEFE] text-xl"></i>
               <span class="ml-4 font-bold text-lg font-main">Data Kepegawaian</span>
               </a>
            </li>
            </ul>
         </div>
         <div class="flex flex-col">
            ...
            <div class="flex flex-row justify-center">
               <div class="flex items-center p-2 pl-10 pr-5 text-base font-normal">
                     ...
                     <!-- Button -->
                     <a href="/logout">
                        <button type="button" class="flex items-center gap-2 text-[#b2fefe] px-2 font-pop text-xl font-bold">
                           LOG OUT
